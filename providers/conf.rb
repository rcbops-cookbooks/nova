action :create do
  ...
  network_setup_info = get_settings_by_role("network-setup", "nova-network")
  ...
  template "/etc/nova/nova.conf" do
    ...
    variables(
        ...
        "fixed_range" => network_setup_info["nova"]["networks"][0]["ipv4_cidr"],
        "public_interface" => network_setup_info["nova"]["network"]["public_interface"],
        "network_manager" => network_setup_info["nova"]["network"]["network_manager"],
        "multi_host" => network_setup_info["nova"]["network"]["multi_host"],
        "scheduler_driver" => network_setup_info["nova"]["scheduler"]["scheduler_driver"],
        ...
        "force_dhcp_release" => network_setup_info["nova"]["network"]["force_dhcp_release"],
        "send_arp_for_ha" => network_setup_info["nova"]["network"]["send_arp_for_ha"],
        "auto_assign_floating_ip" => network_setup_info["nova"]["network"]["auto_assign_floating_ip"],
        ...
        "dhcp_domain" => network_setup_info["nova"]["network"]["dhcp_domain"],
